...
class UNetMidBlock2DCrossAttn(nn.Module):
    ...
    def forward(
        ...
        spatial_attn_inputs = [], # TODO edit add input
        spatial_attn_idx = 0, # TODO edit add input, idx的作用是什么
        ...
        for attn, resnet in zip(self.attentions, self.resnets[1:]):
            if self.training and self.gradient_checkpointing:
                ...
                hidden_states, spatial_attn_inputs, spatial_attn_idx = attn( # TODO edit add returns
                    hidden_states,
                    ...
                    return_dict=False,
                ) # TODO edit remove index 0
                hidden_states = hidden_states[0] # TODO edit 
    ...
    def forward(
        ...
        for i, (resnet, attn) in enumerate(blocks):
            ...
            if self.training and self.gradient_checkpointing:
                ...
                hidden_states, spatial_attn_inputs, spatial_attn_idx = attn( # TODO edit add return
                    hidden_states,
                    spatial_attn_inputs=spatial_attn_inputs, # TODO edit add input
                    spatial_attn_idx=spatial_attn_idx, # TODO edit add input
                    encoder_hidden_states=encoder_hidden_states,
                ...
                hidden_states = resnet(hidden_states, temb, scale=lora_scale)
                # print("====1111hidden_states.shape = ", hidden_states.shape) # torch.Size([8, 320, 64, 48])
                hidden_states, spatial_attn_inputs, spatial_attn_idx = attn( # TODO edit add return
                    hidden_states,
                    spatial_attn_inputs=spatial_attn_inputs, # TODO edit add input
                    spatial_attn_idx=spatial_attn_idx, # TODO edit add input
                ...
                hidden_states = hidden_states[0] # TODO edit
                # print("====2222hidden_states.shape = ", hidden_states.shape)
    ...
    def forward(
        ...
        for resnet, attn in zip(self.resnets, self.attentions):
            ...
            if self.training and self.gradient_checkpointing:
                ...
                hidden_states, spatial_attn_inputs, spatial_attn_idx = attn( # TODO edit
                    hidden_states,
                    spatial_attn_inputs=spatial_attn_inputs, # TODO edit
                    spatial_attn_idx=spatial_attn_idx, # TODO edit
                    encoder_hidden_states=encoder_hidden_states,
                    cross_attention_kwargs=cross_attention_kwargs,
                    attention_mask=attention_mask,
                    encoder_attention_mask=encoder_attention_mask,
