...
class UNetMidBlock2DCrossAttn(nn.Module):
    ...
    def forward(
        ...
        spatial_attn_inputs = [], # TODO add input
        ...
        for attn, resnet in zip(self.attentions, self.resnets[1:]):
            if self.training and self.gradient_checkpointing:
                ...
                hidden_states, spatial_attn_inputs = attn( # TODO add return
                    hidden_states,
                    spatial_attn_inputs=spatial_attn_inputs, # TODO add input
        ...
        return hidden_states, spatial_attn_inputs # TODO add return
    ...
    def forward(
        ...
        for i, (resnet, attn) in enumerate(blocks):
            ...
            if self.training and self.gradient_checkpointing:
                ...
                hidden_states, spatial_attn_inputs = attn( # TODO add return 
                    hidden_states,
                    spatial_attn_inputs=spatial_attn_inputs, # TODO add parameter input
                    encoder_hidden_states=encoder_hidden_states,
                    cross_attention_kwargs=cross_attention_kwargs,
                    attention_mask=attention_mask,
                    encoder_attention_mask=encoder_attention_mask,
        ...
        return hidden_states, output_states, spatial_attn_inputs # TODO add return 
...
class CrossAttnUpBlock2D(nn.Module): # TODO这边要去加一下 
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
    ...
    def forward(
        ...
        hidden_states: torch.FloatTensor,
        res_hidden_states_tuple: Tuple[torch.FloatTensor, ...],
        spatial_attn_inputs = [], # TODO add para 
        temb: Optional[torch.FloatTensor] = None,
        encoder_hidden_states: Optional[torch.FloatTensor] = None,
        cross_attention_kwargs: Optional[Dict[str, Any]] = None,
        upsample_size: Optional[int] = None,
